      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          ...
          <input
            ...
            onChange={(e) => setUserDetails({...userDetails, idNo: e.target.value})}
          />
        </div>
        ...
        <div>
          ...
          <input
            ...
            onChange={(e) => setUserDetails({...userDetails, ipStation: e.target.value})}
          />
        </div>
        ...
        <div>
          ...
          <input
            ...
            onChange={(e) => setUserDetails({...userDetails, facultyMentor: e.target.value})}
          />
        </div>
        ...
        <div>
          ...
          <input
            ...
            onChange={(e) => setUserDetails({...userDetails, companyMentor: e.target.value})}
          />
        </div>
