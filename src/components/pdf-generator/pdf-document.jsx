        ...
        <View style={styles.coverPage}>
          ...
          <View style={styles.detailsContainer}>
            <View style={styles.detailRow}>
              ...
              <Text style={styles.value}>: {userDetails?.name || '_________________'}</Text>
            </View>
            <View style={styles.detailRow}>
              <Text style={styles.label}>ID No.</Text>
              <Text style={styles.value}>: {userDetails?.idNo || '_________________'}</Text>
            </View>
            <View style={styles.detailRow}>
              <Text style={styles.label}>IP Station</Text>
              <Text style={styles.value}>: {userDetails?.ipStation || '_________________'}</Text>
            </View>
            <View style={styles.detailRow}>
              <Text style={styles.label}>Duration</Text>
              <Text style={styles.value}>: {userDetails?.duration?.from || '_________'} to {userDetails?.duration?.to || '_________'}</Text>
            </View>
            <View style={styles.detailRow}>
              <Text style={styles.label}>Faculty Mentor</Text>
              <Text style={styles.value}>: {userDetails?.facultyMentor || '_________________'}</Text>
            </View>
            <View style={styles.detailRow}>
              <Text style={styles.label}>Company Mentor</Text>
              <Text style={styles.value}>: {userDetails?.companyMentor || '_________________'}</Text>
            </View>
          </View>
